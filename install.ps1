...
(
    ...
    [Parameter(HelpMessage = 'Experimental features of Spotify are not included')]
    [switch]$exp_standart,
...
function Set-ScriptLanguageStrings {
    ...
    begin {
        ...
        $langStringsEN = [PSCustomObject]@{
            ...
            DownBts         = "Downloading latest Spotify patch..."
            ...
            NoVariable4     = "in html"
            ModSpoti        = "Patching Spotify (Remove Ad and UPGRADE Button)..."
            Error           = "Error"
            ...
            InstallComplete = "Patching Completed. Enjoy Your Spotify!"
...
Write-Host "@Agung_jays" -ForegroundColor DarkYellow
Write-Host "-------------------"`n
